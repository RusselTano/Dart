...
// let choices = ["R","P","C"];
// if let userInput = readLine()?.uppercased(), choices.va.contains(userInput){
//   let userChoice = userInput
//   print("Vous avez choisi \(choices[userChoice]!)")
// }
// print(choices)

// let choices1 = ["Pierre", "Feuille", "Ciseaux"]
// if let choixAleatoire = choices1.randomElement() {
//     print("Le choix aléatoire est : \(choixAleatoire)")
// }
